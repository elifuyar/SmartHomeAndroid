package com.example.user.akillievkontrol;
...
public class MainActivity extends Activity {
    ...
    Button sicak, hareket, kapi1 , kapi2, sicaklik;
    TextView txt;
    Handler h;
    Switch sw;
    Point p;
    ...
    public static String address = "20:16:01:25:39:32"; //Bu kısıma kendi bluetooth adresimizi yazıyoruz
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sicak = (Button) findViewById(R.id.show_popup);
        hareket = (Button) findViewById(R.id.hareket);
        txt = (TextView) findViewById(R.id.textView1);
        kapi1 = (Button) findViewById(R.id.kapi1);
        kapi2 = (Button) findViewById(R.id.kapi2);
  ...
  /*   *-*-*-*-*-*-*-*-*   FONKSIYON BOLUMU *-*-*-*--*-*-*-*- */
    ...
    private void showPopup(final Activity context, Point p) {
        ...
        // Some offset to align the popup a bit to the rightS, and a bit down, relative to button's position.
        int OFFSET_X = 0;
        int OFFSET_Y = 0;
        ...
        sw = (Switch) layout.findViewById(R.id.switch2);
